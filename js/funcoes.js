...
function funcaoConteudo() {
    for (n = 0; n < x.length; n++) {
        document.write("<div id='noticiaBloco'><img src='img/blog_images/" + x[n].getElementsByTagName("imagem")[0].childNodes[0].nodeValue + "'width='250'><div id='noticiaTexto'><div id='noticiaTitulo'><a href='postagem.html?posicao=" + n + "'>" + x[n].getElementsByTagName("titulo")[0].childNodes[0].nodeValue +
